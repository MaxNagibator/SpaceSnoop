...
public sealed class SpaceSnoopTools
{
    ...
    [Description("Как приложению живётся прямо сейчас: отклик интерфейса, занятая память, число сборок мусора, скорость текущей операции и время последнего запуска приложения. Скаляры описывают короткое окно последних 20 замеров (около 10 секунд), история – отдельный ряд за последние минуты, по которому видно, когда именно была просадка. Сверяйте snapshotAgeMs: если оно велико, интерфейс заморожен и замеры не обновлялись, каким бы спокойным ни выглядел отклик. Отвечает мгновенно, ничего не считает и не меняет – с этого стоит начинать разговор «почему тормозит».")]
