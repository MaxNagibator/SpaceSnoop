namespace SpaceSnoop
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            _hardDiskComboBox.Margin = new Padding(6, 6, 6, 6);
            ...
            _startButton.Margin = new Padding(6, 6, 6, 6);
            ...
            _stopButton.Margin = new Padding(6, 6, 6, 6);
            ...
            _directoriesTreeView.Margin = new Padding(6, 6, 6, 6);
            ...
            _useMultithreadingCheckBox.Margin = new Padding(6, 6, 6, 6);
            ...
            _calculateProgressBar.Margin = new Padding(6, 6, 6, 6);
            ...
            _sortGroupBox.Margin = new Padding(6, 6, 6, 6);
            _sortGroupBox.Name = "_sortGroupBox";
            _sortGroupBox.Padding = new Padding(6, 6, 6, 6);
            ...
            _sortModeComboBox.Margin = new Padding(6, 6, 6, 6);
            ...
            _invertSortCheckBox.Margin = new Padding(6, 6, 6, 6);
            ...
            _intensityGroupBox.Margin = new Padding(6, 6, 6, 6);
            _intensityGroupBox.Name = "_intensityGroupBox";
            _intensityGroupBox.Padding = new Padding(6, 6, 6, 6);
            ...
            // _intensityBar
            // 
            _intensityBar.Location = new Point(11, 45);
            _intensityBar.Margin = new Padding(4, 2, 4, 2);
            ...
            _chooseFolderButton.Margin = new Padding(6, 6, 6, 6);
            ...
            // _syncButton
            // 
            _syncButton.Location = new Point(11, 252);
            _syncButton.Margin = new Padding(6, 6, 6, 6);
            _syncButton.Name = "_syncButton";
            _syncButton.Size = new Size(375, 49);
            _syncButton.TabIndex = 9;
            _syncButton.Text = "Синхронизация";
            _syncButton.UseVisualStyleBackColor = true;
            _syncButton.Click += OnSyncButtonClicked;
            // 
            // _mainTabControl
            // 
            ...
            _mainTabControl.Margin = new Padding(6, 6, 6, 6);
            _mainTabControl.Name = "_mainTabControl";
            _mainTabControl.SelectedIndex = 0;
            _mainTabControl.Size = new Size(412, 365);
            ...
            _controlTabPage.Controls.Add(_syncButton);
            _controlTabPage.Location = new Point(8, 46);
            _controlTabPage.Margin = new Padding(6, 6, 6, 6);
            _controlTabPage.Name = "_controlTabPage";
            _controlTabPage.Padding = new Padding(6, 6, 6, 6);
            _controlTabPage.Size = new Size(396, 311);
            ...
            _settingsTabPage.Margin = new Padding(6, 6, 6, 6);
            _settingsTabPage.Name = "_settingsTabPage";
            _settingsTabPage.Padding = new Padding(6, 6, 6, 6);
            ...
            _infoTextBox.Location = new Point(30, 395);
            _infoTextBox.Margin = new Padding(6, 6, 6, 6);
            _infoTextBox.Name = "_infoTextBox";
            _infoTextBox.ReadOnly = true;
            _infoTextBox.ScrollBars = RichTextBoxScrollBars.Vertical;
            _infoTextBox.Size = new Size(394, 588);
